...
func TestFloat32(t *testing.T) {
	...
	b := NewBuffer()
	err := b.Write_float32(testFloat, byte(10))
	if err != nil {
		t.Error(err)
	}

	var data float32
	err = r(b).Read_float32(&data, byte(10), true)
	if err != nil {
		t.Error(err)
	}
	if data != testFloat {
...
func TestFloat32_ZeroTag(t *testing.T) {
...
func TestFloat64(t *testing.T) {
	var testFloat float64 = 3.14

	b := NewBuffer()
	err := b.Write_float64(testFloat, byte(10))
	if err != nil {
		t.Error(err)
	}

	var data float64
	err = r(b).Read_float64(&data, byte(10), true)
	if err != nil {
		t.Error(err)
	}
	if data != testFloat {
...
func TestFloat64_ZeroTag(t *testing.T) {
	var testFloat float64 = 0
